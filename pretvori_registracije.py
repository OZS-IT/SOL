...
with open("Registracije/registracije3c.csv","r",encoding="utf-8") as f:
    with open("Registracije/registracije3c.csv","w",encoding="utf-8") as g:
        a = f.read()
        b = a.split("\n")
